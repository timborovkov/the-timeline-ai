...
- Meta describes Groups API groups as Official Business Account (OBA) functionality, with invite-only membership and a documented eight-participant limit. Product must validate OBA eligibility before committing to a pilot. [Groups API](https://developers.facebook.com/documentation/business-messaging/whatsapp/groups/)
