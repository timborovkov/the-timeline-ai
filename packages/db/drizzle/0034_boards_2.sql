...
CREATE INDEX "board_pins_team_user_position_idx" ON "board_pins" USING btree ("team_id","user_id","position");--> statement-breakpoint
DROP TABLE IF EXISTS "board_views";--> statement-breakpoint
