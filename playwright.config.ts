...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      NEXT_PUBLIC_POSTHOG_KEY: e2eEnv.NEXT_PUBLIC_POSTHOG_KEY,
      NEXT_PUBLIC_POSTHOG_HOST: e2eEnv.NEXT_PUBLIC_POSTHOG_HOST,
      ...
      TASK_CATEGORY_CLASSIFICATION_ENABLED: e2eEnv.TASK_CATEGORY_CLASSIFICATION_ENABLED,
      TASK_CATEGORY_AUTO_ENQUEUE_ENABLED: e2eEnv.TASK_CATEGORY_AUTO_ENQUEUE_ENABLED,
      TASK_CATEGORY_WORKER_ENABLED: e2eEnv.TASK_CATEGORY_WORKER_ENABLED,
      TASK_CATEGORY_UI_ENABLED: e2eEnv.TASK_CATEGORY_UI_ENABLED,
