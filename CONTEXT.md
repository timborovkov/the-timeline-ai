...
the sticky CollectionToolbar sits flush under the 48px shell header
(`flush-top`), keeps Search timeline, Filters, and source presets, and
paging continues after each loaded page. Timeline has no
