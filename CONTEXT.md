...
attention, keeps capture in a focused dialog, and follows with a folded latest
digest, pinned work, up to three recent moments, and one next setup step. The
digest opens into narrative summaries of what changed; Work → Digests lists
every stored day. It does not duplicate the canonical Timeline, Work navigation,
or Connections management.
