...
Most recent full-suite inventory predates the timeline-moments slice and is
...
adds stable moment-row anchor assertions, mixed raw-page boundary cursor
regression coverage, and outbound MCP moment list/expand coverage for
team-visible evidence, supported moment-ID-only expansion, and raw-event
snippet fencing. Previous full-suite shape:
