...
- Shared Vitest: 64 files / 570 tests plus 1 skipped, including PGlite
  integration/eval coverage plus queue, S3, and onboarding contracts.
- Web Vitest: 74 files / 377 tests, including route/action/component coverage
  for core recovery, onboarding, object sections, and first high-value UI
  states.
- Worker Vitest: 11 files / 114 tests, including extract, transcribe,
