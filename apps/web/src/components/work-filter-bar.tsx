  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-end gap-2">
        ...
        {mode === 'objects' ? (
          <PersonSelect name="owner" label="Owner" defaultValue={filters.owner} members={members} />
        ) : null}
        ...
        <output
          className="pb-2 font-mono text-[11px] uppercase tracking-[0.12em] text-fg-dim"
          aria-live="polite"
        >
...
function PersonSelect({
  ...
  return (
    <FilterSelect name={name} label={label} defaultValue={defaultValue}>
