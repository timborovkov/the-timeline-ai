...
import { readCollectionSlots } from '@/components/collections/collection-slot';
import { COLLECTION_TOOLBAR_SLOTS } from '@/components/collections/collection-toolbar-slots';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function CollectionToolbar({
  ...
  const slots = readCollectionSlots(children, COLLECTION_TOOLBAR_SLOTS);
