...
export const OBJECT_TITLE_CLASS = 'text-lg font-semibold leading-snug tracking-tight text-fg';

/** Sticky section titles — "Evidence · 12", "Connected work", "Discussion". */
export const OBJECT_SECTION_CLASS = 'text-[13px] font-semibold tracking-[-0.01em] text-fg';

/** Soft subgroup under a section — "Open tasks", "Documents". */
export const OBJECT_GROUP_CLASS = 'text-[11px] font-medium tracking-[0.01em] text-fg-muted';

/** Primary list-row title / entity link (14px medium). */
export const OBJECT_ROW_TITLE_CLASS = 'text-sm font-medium leading-[1.35] text-fg';

/** Body copy — property values, note text, prose blocks. */
export const OBJECT_BODY_CLASS = 'text-sm font-normal leading-[1.45] text-fg';

/** Secondary line under a row (source, status, relationship). */
export const OBJECT_ROW_META_CLASS = 'text-xs font-normal leading-snug text-fg-dim';
...
export const OBJECT_QUIET_CLASS = 'text-xs font-normal text-fg-faint';
...
export const OBJECT_RAIL_VALUE_CLASS = 'text-sm font-normal leading-5 text-fg';
